...
-- Function to get themes with strategic scoring efficiently
CREATE OR REPLACE FUNCTION get_themes_with_strategic_scoring(
    p_company_id UUID,
    p_sort_by TEXT DEFAULT 'strategic_priority',
...
BEGIN
    ...
    ORDER BY 
        CASE WHEN p_sort_by = 'strategic_priority' THEN t.final_priority_score END DESC,
...
-- Function to calculate strategic health metrics efficiently
...
BEGIN
    ...
    AND t.tablename IN ('themes', 'feedback_items', 'tag_usages', 'ai_cost_logs')
